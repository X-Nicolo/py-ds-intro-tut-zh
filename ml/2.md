...
> ԭ�ģ�[Support Vector Machine Parameters](https://pythonprogramming.net/support-vector-machine-parameters-machine-learning-tutorial/)

> ���ߣ�[����](https://github.com/wizardforcel)

> Э�飺[CC BY-NC-SA 4.0](http://creativecommons.org/licenses/by-nc-sa/4.0/)

��ӭ�Ķ�����ʮ��ƪ�̳̣���ƪ�̳��У����Ǵ���ͨ��������δ������� 2 �����࣬�Լ�¬�� Sklearn �� SVM �Ĳ��������� SVM ������β�����������ʶһ������ SVM ���ִ������ۡ�

���ȣ����Ѿ�ѧ���ˣ�SVM �Ǹ���Ԫ��������Ҳ����˵���κ�ʱ��SVM �����Ż���ֻ�ܽ�һ����������һ��������롣֮��������������ζ���������������ࡣͨ�����������ǡ�һ����������OVR���������������ǣ���ÿ�����������ķ�����롣���磬Ϊ�˷����������飨1��2 �� 3������Ӧ�����Ƚ� 1 �� 2 �� 3 ���롣֮�� 2 �� 1 �� 3����� 3 �� 1 �� 2 ���롣������һЩ���⣬��Ϊ�������ŶȵĶ��������ܶ���ÿ������߽綼��ͬ���Լ��ָ��߽������һЩȱ�ݣ���Ϊ��һЩ������������͸���Ķ������㽫һ�����������������Ƚϡ������ʼ��һ����������ݼ���Ҳ����˵ÿ������ı߽�����ǲ�����ġ�

![](img/33-1.png)

��һ�������ǡ�һ��һ����OVO�����������£��������ܹ�ӵ���������顣���Ĺ�����ʽ�ǣ���ı߽�� 1 ���� 3���Լ��� 1 ���� 2�����Ҷ���������ظ�������̡��������߽�ͻ�����⡣

![](img/33-2.png)

��һ��������`C`��������������һ�����߽������������԰������`C`�����ҿ���ʹ`C`�㹻��������Ӳ�߽��������`C`��`||w||`�����߽��Ż�������

![](img/33-3.png)

`C`��Ĭ��ֵ�� 1�����Ҷ�������¶��ܺá�

���������и�`kernel`��ѡ�����Ĭ����`rbf`�ˣ���������Ե���Ϊ`linear`��`poly`������ʽ����`sigmoid`�ˣ�������ѡ�����Ƶ��Զ���ˡ�

Ȼ�󣬻���`degree`ֵ��Ĭ��Ϊ 3������Ƕ���ʽ�Ľ���������㽫`poly`����`kernel`�����Ļ���

`gamma`����Ϊ`rbf`������ Gamma ֵ�ĵط�����Ӧ�ý��䱣��Ϊ`auto`��

`coef0`����������˺����Ķ����������Ӧ�ñ������䣬������ֻ���ڶ���ʽ�� sigmoid �ˡ�

`probability `��������ܶ����ʹ�á����� KNN �㷨������ӵ��ģ��׼ȷ�ȣ�ÿ��Ԥ�⻹ӵ�����Ŷȡ�SVM ������û��������ԣ����������ʹ��`probability `��������ȡһ����ʽ�����Ǹ�������Ĺ��ܣ����ǿ��ܶ�����˵�㹻��Ҫ������Ĭ��ֵΪ`False`��

������`shrinking`����ֵ����Ĭ��Ϊ`True`��������ڱ�ʾ���Ƿ�����ʽ���� SVM ���Ż�����ʹ����������С�Ż���SMO������Ӧ�ý��䱣��Ϊ`True`����Ϊ�����Լ�������������ܣ�����ֻ��ʧһ���׼ȷ�ԡ�

`tol`���������� SVM ���ݲǰ��˵��`yi(xi.w+b)-1 >= 0`������ SVM ��˵������ֵ��������ڵ��� 0��ÿһ������һ��ֵҪ���� 0����������֧�������������㲻������ֵ������������ȫ���� 0������Ҫ����һ���ݲ�����ȡһЩ���Կռ䡣Sklearn ��Ĭ�ϵ� `tol`��`1e-3`��Ҳ���� 0.001��

��һ����Ҫ�Ĳ�����`max_iter`�����������Ϊƽ���滮���������������ĵط���Ĭ��ֵΪ`-1`��Ҳ����û�����ơ�

`decision_function_shape `��һ��һ��OVO��������һ��������OVR�����Ǿ��ǽ̳̿�ʼ���۵ĸ��


`random_state `���ڸ��ʹ����е����ӣ���������ָ���Ļ���

������Щ���������ǻ��м������ԡ�

`support_ `�ṩ��֧��������������`support_vectors_ `�ṩ��ʵ�ʵ�֧��������`n_support_`��֧�������ĸ��������������ݼ���һЩͳ�����⣬������������ݼ��ߴ���ȷǳ�ʵ�á��������������`dual_coef_`��` coef_`��`intercept_`������������� SVM����ǳ�ʵ�á�
